...
const Home = ({ services, blogPosts, testimonials }) => {
    ...
    return (
        <Layout>
            ...
            </section>            {/* Stats Section with Waves */}
            <section className="relative bg-white w-full overflow-visible">
                ...
                <div className="absolute top-0 left-0 w-full" style={{ marginTop: '-1px', pointerEvents: 'none' }}>
                    ...
                    {/* Front wave */}
                    <svg className="absolute w-full" viewBox="0 0 1440 320" preserveAspectRatio="none" style={{ height: '180px', top: '-60px', display: 'block' }}>
                        <path fill="#ffffff" d="M0,224L48,213.3C96,203,192,181,288,186.7C384,192,480,224,576,224C672,224,768,192,864,165.3C960,139,1056,117,1152,128C1248,139,1344,181,1392,202.7L1440,224L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
                    </svg>
                </div>

                {/* Stats Content */}
                <div className="relative z-20 pt-28 pb-20 sm:pt-36 sm:pb-28">
                    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 md:gap-16 items-stretch">
                            {/* Veterans Served */}
                            <Link href="/contact" className="flex flex-col items-center text-center group h-full justify-between">
                                <div className="w-36 h-36 sm:w-40 sm:h-40 rounded-full flex items-center justify-center shadow-2xl mb-6 transform group-hover:scale-105 transition-transform cursor-pointer" style={{ backgroundColor: '#B91C3C' }}>
                                    <Users className="w-14 h-14 sm:w-16 sm:h-16 text-white" />
                                </div>
                                <div className="flex flex-col items-center">
                                    <div className="text-3xl sm:text-4xl font-bold text-slate-900 mb-2">1,000+</div>
                            ...
                            {/* Average Turnaround */}
                            <Link href="/community" className="flex flex-col items-center text-center group h-full justify-between">
                                <div className="w-36 h-36 sm:w-40 sm:h-40 rounded-full flex items-center justify-center shadow-2xl mb-6 transform group-hover:scale-105 transition-transform cursor-pointer" style={{ backgroundColor: '#B91C3C' }}>
                            ...
                            {/* Satisfaction Rate */}
                            <Link href="/case-studies" className="flex flex-col items-center text-center group h-full justify-between">
                                <div className="w-36 h-36 sm:w-40 sm:h-40 rounded-full flex items-center justify-center shadow-2xl mb-6 transform group-hover:scale-105 transition-transform cursor-pointer" style={{ backgroundColor: '#B91C3C' }}>
                                    <Award className="w-14 h-14 sm:w-16 sm:h-16 text-white" />
                                </div>
                                <div className="flex flex-col items-center">
            ...
            <section className="relative bg-gradient-to-br from-navy-600 via-navy-700 to-navy-800 text-white pt-28 pb-28 sm:pt-36 sm:pb-36 w-full" style={{ marginTop: '-2px' }}>
                {/* Top Wave Transition */}
                <div className="absolute top-0 left-0 w-full" style={{ marginTop: '-1px', pointerEvents: 'none' }}>
                    ...
                    {services.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                            {services.map((service) => (
                                <article
                                    key={service.id}
                                    className="bg-white/10 backdrop-blur-md rounded-xl p-6 sm:p-8 border border-white/20 hover:bg-white/20 transition-all hover:scale-105 h-full flex flex-col justify-between"
                                >
                                    <div>
                                        <h3 className="text-xl font-bold mb-3">{service.title}</h3>
                                        <div className="text-white/80 text-sm mb-6 leading-relaxed whitespace-pre-wrap flex-grow">
                                    ...
                                    <Link
                                        ...
                                        className="inline-flex items-center text-white font-semibold text-sm hover:text-navy-200 transition-colors mt-auto pt-2"
                ...
                <div className="absolute bottom-0 left-0 w-full" style={{ marginBottom: '-2px', pointerEvents: 'none' }}>
                    <svg className="w-full" viewBox="0 0 1440 120" preserveAspectRatio="none" style={{ height: '120px', display: 'block', verticalAlign: 'middle' }}>
                        <path fill="#020617" fillOpacity="1" d="M0,64L48,69.3C96,75,192,85,288,80C384,75,480,53,576,48C672,43,768,53,864,64C960,75,1056,85,1152,80C1248,75,1344,53,1392,42.7L1440,32L1440,120L1392,120C1344,120,1248,120,1152,120C1056,120,960,120,864,120C768,120,672,120,576,120C480,120,384,120,288,120C192,120,96,120,48,120L0,120Z"></path>
                    </svg>
                </div>
            </section>

            {/* How It Works Section - Dark Background */}
            <section className="relative bg-slate-950 text-white pt-24 pb-28 sm:pt-28 sm:pb-32 md:pt-32 md:pb-36 w-full" style={{ marginTop: '-2px' }}>
                <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10">
                        {[
                            ...
                            <div key={step.num} className="text-center flex flex-col items-center justify-start h-full">
                                <div className="text-5xl sm:text-6xl font-bold text-navy-500/30 mb-3 sm:mb-4 leading-none">{step.num}</div>
