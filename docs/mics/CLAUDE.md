...
This project is indexed by GitNexus as **militarydisabilitynexus** (3228 symbols, 4685 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
